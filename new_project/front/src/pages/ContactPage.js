...
class ContactPage extends React.Component {
    ...
    onChange(e){
        ...
        oldState[e.target.phone] = e.target.value
    ...
    validateForm(){
        ...
        if(oldState.email.length === 0) {
            oldState.isEmailValid = false
            oldState.inpNameClass = 'form-control is-invalid'
        } else {
            oldState.isEmailValid = true
            oldState.inpNameClass = 'form-control'
        }

        //validate phone
        if(oldState.phone.length === 0 && typeof oldState.phone.value != 'number') {
            oldState.isPhoneValid = false
            oldState.inpNameClass = 'form-control is-invalid'
        } else {
            oldState.isPhoneValid = true
            oldState.inpNameClass = 'form-control'
        }
